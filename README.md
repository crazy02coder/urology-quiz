...
5. Oturumdaki tüm sorular seçtiğiniz süre kadar açık kalır. Oturum başladıktan sonra süre değiştirilemez. Herkes cevap verse bile süre kısalmaz. Katılımcı süre bitene kadar cevabını değiştirebilir; son seçimi geçerlidir.
...
- Veritabanı benzersizlik kuralları ve atomik işlemler yinelenen cevapları engeller. Soru açıkken cevap değiştirilebilir; kişi başına tek kayıt tutulur ve son seçim geçerlidir. Süre bitince tekrarlar dahil tüm cevap istekleri reddedilir. Yönetici kontrolü beklenen oturum sürümünü, oturum oluşturma ise istek kimliğini kullanır.
